...
# nazwy kolumn do wyjêcia z tabeli
selected_cols = c(
...
# zmiana wartoœci w kilku zmiennych 
dt[, nperps := ifelse(is.na(nperps) | nperps < 0, 1, nperps)] # zak³adamy sobie, ¿e minumum zawsze jest jeden sprawca
...
# zwraca tabelê do zak³adki National Statisticks 
